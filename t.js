! function(e) {
	...
	}, i.p = "https://cdn.fluidplayer.com/v3/current/", i.oe = function(e) {
	...
	var s = [function(e, t) {
			...
			e.renderLinearAd = function(t, o) {
				...
				var t = document.createElement("div");
				t.id = "skip_button_" + e.videoPlayerId, t.className = "skip_button skip_button_disabled", e.vastOptions.skipoffset > 0 && (t.innerHTML = e.displayOptions.vastOptions.skipButtonCaption.replace("[seconds]", e.vastOptions.skipoffset)), document.getElementById("fluid_video_wrapper_" + e.videoPlayerId).appendChild(t), 0 === e.vastOptions.skipoffset && e.decreaseSkipOffset(), e.domRef.player.addEventListener("timeupdate", e.decreaseSkipOffset, !1)
		...
		c = function() {
			...
			t.domRef = {
				player: null
			}, t.version = "3.12.0", t.homepage = "https://fluidplayer.com/?utm_source=player&utm_medium=context_menu&utm_campaign=organic", t.destructors = [], t.init = function(e, n) {
				var o, i, r = {
						development: !1,
						debug: !1
					},
				...
				if (t.displayOptions.layoutControls.playbackRateEnabled) {
					...
					var e = document.getElementById(t.videoPlayerId + "_fluid_control_playback_rate"),
						n = document.createElement("div");
					n.id = t.videoPlayerId + "_fluid_control_video_playback_rate", n.className = "fluid_video_playback_rates", n.style.display = "none", Array.isArray(t.displayOptions.layoutControls.controlBar.playbackRates) && !t.displayOptions.layoutControls.controlBar.playbackRates.some((function(e) {
						return "string" != typeof e || Number.isNaN(Number(e.replace("x", "")))
					})) || (t.displayOptions.layoutControls.controlBar.playbackRates = ["x2", "x1.5", "x1", "x0.5"]), t.displayOptions.layoutControls.controlBar.playbackRates.forEach((function(e) {
						var o = document.createElement("div");
