...
function app_match_wildcard_domain(e, n) {
	...
	for (i = 0; i < p.length; i++)
		if (n.substr(-1 * p[i].length) === p[i]) return !0;
	return !1
}
	...
	if ("undefined" == typeof app_domains)
		if ("undefined" == typeof app_exclude_domains && "undefined" != typeof adlinkfly_exclude_domains && (app_exclude_domains = adlinkfly_exclude_domains), "undefined" == typeof app_exclude_domains);
			...
			for (a = 0; a < p.length; a++) {
				0 < (t = app_get_host_name(p[a].getAttribute("href"))).length && !1 === app_domain_exist(app_exclude_domains, t) ? p[a].href = app_url + "full?api=" + encodeURIComponent(app_api_token) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n) : "magnet:" === p[a].protocol && (p[a].href = app_url + "full?api=" + encodeURIComponent(app_api_token) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n))
			} else
				for (var a = 0; a < p.length; a++) {
					var t;
					0 < (t = app_get_host_name(p[a].getAttribute("href"))).length && app_domain_exist(app_domains, t) ? p[a].href = app_url + "full?api=" + encodeURIComponent(app_api_token) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n) : "magnet:" === p[a].protocol && (p[a].href = app_url + "full?api=" + encodeURIComponent(app_api_token) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n))
				}
});
...
document.addEventListener("DOMContentLoaded", function(e) {
	...
	if ("undefined" == typeof shorten_includ)
		if ("undefined" == typeof shorten_exclude);
			...
			for (a = 0; a < p.length; a++) {
				0 < (t = app_get_host_name(p[a].getAttribute("href"))).length && !1 === app_domain_exist(shorten_exclude, t) ? p[a].href = go_url + "full?api=" + encodeURIComponent(api) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n) : "magnet:" === p[a].protocol && (p[a].href = go_url + "full?api=" + encodeURIComponent(api) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n))
			} else
				for (var a = 0; a < p.length; a++) {
					var t;
					0 < (t = app_get_host_name(p[a].getAttribute("href"))).length && app_domain_exist(shorten_includ, t) ? p[a].href = go_url + "full?api=" + encodeURIComponent(api) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n) : "magnet:" === p[a].protocol && (p[a].href = go_url + "full?api=" + encodeURIComponent(api) + "&url=" + app_base64_encode(p[a].href) + "&type=" + encodeURIComponent(n))
				}
});
